...
import { animationSteps$ } from 'src/app/otherModules/svg/classes/animation-steps$';
import { IAnimationSteps } from 'src/app/otherModules/svg/classes/i-animation-steps';
