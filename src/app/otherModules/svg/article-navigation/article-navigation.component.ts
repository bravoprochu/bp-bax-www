...
import { NewsService } from 'src/app/sites/news/newsServices/news.service';
import { Router } from '@angular/router';
import { INewsArticle } from 'src/app/sites/news/interfaces/i-news-article';
import { ISVGIconsList } from '../../../shared/article-container/interfaces/i-svg-icons-list';
import { fromEvent, Subject, of } from 'rxjs';
import { NewsArticleComponent } from 'src/app/sites/news/news-article/news-article.component';
